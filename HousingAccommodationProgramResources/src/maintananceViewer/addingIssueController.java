 ...
 * @author muzab
 */
public class addingIssueController implements Initializable {
    ...
    public ObservableList<String> tennantData = FXCollections.<String>observableArrayList();
    public ObservableList<String> priorityData = FXCollections.<String>observableArrayList();
    @FXML
    ...
    public void addNewIssue() {
        connected = connectSQL.returnConnection();
        String Sqlite = "INSERT INTO issues(Description,reportedBy,Date,Status,levelOfUrgency,propertyID)VALUES (?,?,?,?,?,?)";
        ...
        try {
            ...
            preparedStatement.setString(5, priorityLevel.getValue());
            preparedStatement.setString(6, propertyList.getValue().getPropertyID());
